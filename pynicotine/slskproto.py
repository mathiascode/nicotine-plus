...
class SlskProtoThread(threading.Thread):
    ...
    def bind_to_network_interface(self, sock, if_name):
        ...
        # Other systems don't support changing the network interface
        # Retrieve the IP address of the interface, and bind to it instead
        # TODO: figure out a way to retrieve the IP address on Windows

        self._bindip = self.get_interface_ip_address(if_name)
    ...
    def bind_listen_port(self):
        ...
        if self.interface:
            if sys.platform in ("linux", "darwin"):
                ...
                ip_address = self.get_interface_ip_address(self.interface)
