...
class Transfers:
    ...
    def queue_upload(self, msg):
        ...
        """ Under certain conditions, SoulseekQt will send a file name/path with mixed encodings
        (utf-8 incorrectly decoded as latin-1 + utf-8). This was observed when a file name contains
        special characters, and is downloaded directly from a user share. Downloading from search
        results results in no such issue.
