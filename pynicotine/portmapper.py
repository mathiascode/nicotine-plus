    ...
    class SSDP:
        ...
        def get_services(private_ip):
            ...
            with socket.socket(family=socket.AF_INET, type=socket.SOCK_DGRAM, proto=socket.IPPROTO_UDP) as sock:
                ...
                request = UPnP.SSDPRequest("upnp:rootdevice")
                request.sendto(sock, (UPnP.MULTICAST_HOST, UPnP.MULTICAST_PORT))
                log.add_debug("UPnP: Sent M-SEARCH UPnP root device request")
