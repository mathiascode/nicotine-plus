...
class UserBrowse:
    ...
    def __init__(self, userbrowses, user):
        ...
        folder_pane_width = self.frame.np.config.sections["panes"]["user_browse"]["folder"]["width"]
        self.FolderPane.set_size_request(folder_pane_width, -1)
    ...
    def save_panes(self):
        folder_pane_width = self.FolderPane.get_allocation().width
        self.frame.np.config.sections["panes"]["user_browse"]["folder"]["width"] = folder_pane_width
