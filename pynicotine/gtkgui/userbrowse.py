...
class UserBrowse:
    ...
    def shared_file_list(self, msg):
        ...
        if msg.list or msg.privatelist:
            ...
            self.info_icon.set_property("icon-name", "folder-open-symbolic")
            self.info_title.set_label(_("No Files Shared"))
            self.info_message.set_label(
                _("%(user)s is either not sharing anything, or sharing files privately") % {"user": self.user}
            )
    ...
    def peer_connection_error(self):
        ...
        self.info_icon.set_property("icon-name", "network-offline-symbolic")
        self.info_title.set_label(_("Cannot Browse Shares"))
        self.info_message.set_label(
    ...
    def on_focus(self, *_args):
        ...
        if self.info_container.get_visible():
