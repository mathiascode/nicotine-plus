    ...
    def __init__(self, application):
        ...
        self.options = {
            "transfers": {
                ...
                "rescan_interval": self.rescan_interval_spinner,
    ...
    def get_settings(self):
        ...
        return {
            "transfers": {
                ...
                "rescan_interval": self.rescan_interval_spinner.get_value_as_int(),
...
class Preferences(Dialog):
    ...
    def get_settings(self):
        ...
        rescan_interval_required = self.has_option_changed(options, "transfers", "rescan_interval")
    ...
    def update_settings(self, settings_closed=False):
        ...
        if not rescan_required:
            if rescan_interval_required:
                core.shares.start_rescan_interval_timer()
