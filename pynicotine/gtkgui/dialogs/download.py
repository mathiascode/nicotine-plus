...
class Download(Dialog):
    ...
    def __init__(self, application):
        ...
        self.has_custom_download_location = False
        ...
        self.download_folder_button = FileChooserButton(
            ...
            chooser_type="folder", selected_function=self.on_download_folder_selected
        )
    ...
    def update_title(self):
        ...
        self.set_title(_("Download %(num_files)s file(s) (%(total_size)s)") % {
            "num_files": humanize(self.num_selected_files),
    ...
    def on_select_all(self, *_args):
        ...
        for iterator in self.tree_view.iterators.values():
            ...
            if row_id not in self.parent_iterators:
                self.num_selected_files += 1
    ...
    def on_select_file(self, tree_view, iterator):
        ...
        if row_id in self.parent_iterators:
            ...
            if not selected:
                tree_view.set_row_value(parent_iterator, "selected", selected)
    ...
    def on_download_folder_selected(self):
        self.has_custom_download_location = True
    ...
    def on_download(self, *_args):
        ...
        for iterator in self.tree_view.iterators.values():
            ...
            if self.enable_subfolders_toggle.get_active():
                if self.has_custom_download_location:
