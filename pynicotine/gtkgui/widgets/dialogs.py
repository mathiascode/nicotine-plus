...
class MessageDialog(Window):
    ...
    def _create_dialog_adw(self, title, message, buttons):
        ...
        widget = Adw.MessageDialog(
            transient_for=self.parent.widget if self.parent else None, default_width=self.default_width,
        ...
        for response_type, button_label in buttons:
            ...
            if response_type in ("cancel", "close", "ok"):
    ...
    def _create_dialog_gtk(self, title, message, buttons):
        ...
        self.response_ids.update({
            Gtk.ResponseType.CANCEL: "cancel",
            Gtk.ResponseType.CLOSE: "close",
            Gtk.ResponseType.DELETE_EVENT: "close"
        })
    ...
    def on_response(self, _widget, response_id):
        ...
        if self.callback and response_id not in ("cancel", "close"):
