...
class ChatRoom:
    ...
    def __init__(self, roomsctrl, room, users, meta=False):
        ...
        self.LogSearchNextMatch.connect("clicked", searchbar.OnSearchNextMatch)
        self.LogSearchPreviousMatch.connect("clicked", searchbar.OnSearchPreviousMatch)
        ...
        self.ChatSearchNextMatch.connect("clicked", searchbar.OnSearchNextMatch)
        self.ChatSearchPreviousMatch.connect("clicked", searchbar.OnSearchPreviousMatch)
