...
class DownloadsTest(TestCase):
    ...
    def setUp(self):
        ...
        core.init_components(
            enabled_components={"users", "downloads", "userbrowse"}
        )
    ...
    def test_load_downloads(self):
        ...
        # File attribute dictionary represented as string (downgrade from
        # \>=3.3.0 to earlier and upgrade again)
        self.assertEqual(
            transfers[15].file_attributes,
            {
    ...
    def test_save_downloads(self):
        ...
        old_transfers = core.downloads._load_transfers_file(
            TRANSFERS_FILE_PATH
        )[:12]
        core.downloads._save_transfers()
        saved_transfers = core.downloads._load_transfers_file(
    ...
    def test_long_basename(self):
        ...
        username = "abc"
        finished_folder_path = os.path.join(
            os.sep, "path", "to", "somewhere", "downloads"
        )

        # Short file extension
        virtual_path = (
            "Music\\Test\\片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片"
            "片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片"
            "片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片.mp3"
        )
        incomplete_file_path = (
            core.downloads.get_incomplete_download_file_path(
        ...
        self.assertTrue(
            incomplete_basename.startswith(
                "INCOMPLETE42d26e9276e024cdaeac645438912b88"
            )
        )
        ...
        # Long file extension
        virtual_path = (
            "Music\\Test\\abc123456.片片片片片片片片片片片片片片片片片片片片片片片片"
            "片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片"
            "片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片"
            "片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片"
        )
        incomplete_file_path = (
            core.downloads.get_incomplete_download_file_path(
                username, virtual_path
        ...
        self.assertTrue(
            incomplete_basename.startswith(
                "INCOMPLETEf98e3f07a3fc60e114534045f26707d2."
            )
        )
        ...
        # Finished download
        basename = (
            "片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片"
            "片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片"
            "片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片.mp3"
        )
        finished_basename = core.downloads.get_download_basename(
            basename, finished_folder_path
        )
        ...
        basename = (
            "abc123456.片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片"
            "片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片片"
    ...
    def test_download_folder_destination(self):
        ...
        config.sections["transfers"]["usernamesubfolders"] = False
        destination_default = core.downloads.get_folder_destination(
            username, folder_path
        )

        core.downloads._requested_folders[username][folder_path] = (
            RequestedFolder(
                username=username,
                folder_path=folder_path,
                download_folder_path="test",
            )
        )
        ...
        destination_user = core.downloads.get_folder_destination(
            username, folder_path
        )

        folder_path = "Hello"
        destination_root = core.downloads.get_folder_destination(
            username, folder_path
        )

        folder_path = "Hello\\Path\\Depth\\Test"
        destination_depth = core.downloads.get_folder_destination(
            username, folder_path
        )

        self.assertEqual(
            destination_default,
            os.path.join(config.data_folder_path, "Path"),
        )
        self.assertEqual(destination_custom, os.path.join("test", "Path"))
        self.assertEqual(
            destination_custom_second, os.path.join("test2", "Path")
        )
        self.assertEqual(
            destination_user,
            os.path.join(config.data_folder_path, "newuser", "Path"),
        )
        self.assertEqual(
            destination_root,
            os.path.join(config.data_folder_path, "newuser", "Hello"),
        )
        self.assertEqual(
            destination_depth,
            os.path.join(config.data_folder_path, "newuser", "Test"),
        )
    ...
    def test_download_subfolders(self):
        ...
        self.assertEqual(
            transfers[10].folder_path,
            os.path.join("test", "share", "SoulseekSecond"),
        )
        self.assertEqual(
            transfers[9].folder_path,
            os.path.join("test", "share", "SoulseekSecond"),
        )
        self.assertEqual(
            transfers[8].folder_path,
            os.path.join("test", "share", "Soulseek", "folder2", "sub2"),
        )
        self.assertEqual(
            transfers[7].folder_path,
            os.path.join("test", "share", "Soulseek", "folder2"),
        )
        self.assertEqual(
            transfers[6].folder_path,
            os.path.join("test", "share", "Soulseek", "folder1", "sub1"),
        )
        self.assertEqual(
            transfers[5].folder_path,
            os.path.join("test", "share", "Soulseek", "folder1"),
        )
        self.assertEqual(
            transfers[4].folder_path,
            os.path.join("test", "share", "Soulseek"),
        )
        self.assertEqual(
            transfers[3].folder_path,
            os.path.join("test", "share", "Soulseek"),
        )
        self.assertEqual(
            transfers[2].folder_path,
            os.path.join("test", "share", "Music"),
        )
        self.assertEqual(
            transfers[1].folder_path,
            os.path.join("test", "share", "Music"),
        )
        self.assertEqual(
            transfers[0].folder_path, os.path.join("test", "share")
        )
        ...
        self.assertEqual(
            transfers[5].folder_path,
            os.path.join("test2", "Soulseek", "folder2", "sub2"),
        )
        self.assertEqual(
            transfers[4].folder_path,
            os.path.join("test2", "Soulseek", "folder2"),
        )
        self.assertEqual(
            transfers[3].folder_path,
            os.path.join("test2", "Soulseek", "folder1", "sub1"),
        )
        self.assertEqual(
            transfers[2].folder_path,
            os.path.join("test2", "Soulseek", "folder1"),
        )
        self.assertEqual(
            transfers[1].folder_path, os.path.join("test2", "Soulseek")
        )
        self.assertEqual(
            transfers[0].folder_path, os.path.join("test2", "Soulseek")
        )
