...
class UtilsTest(TestCase):
    ...
    def test_safe_path_join(self):
        ...
        self.assertEqual(
            ...
            os.path.abspath(
                os.sep.join(["C:", "basepath", "folder", "_", "_", "_", "_", "_name", "D_relative", "C__absolute"])
            )
        )
        self.assertEqual(
            safe_path_join(
            ...
            os.sep.join([base, "relative", "basepath", "folder", "_", "_", "_", "_", "_name", "relative", "_absolute"])
        )
        self.assertEqual(
            safe_path_join(
            ...
            os.path.abspath(
                os.sep.join([
                    "", "absolute", "basepath", "folder", "_", "_", "_", "_", "_name", "relative", "_absolute"
                ])
            )
        )
        self.assertEqual(
            ...
            os.sep.join([base, "base", "path", "_basename-with-illegal-_chars_-_______-extra-__", "_", "_absolute"])
        )
        self.assertEqual(
            safe_path_join(
                os.sep.join(["base", "path"]),
        ...
        self.assertEqual(
            ...
            os.sep.join([
                base, "base", "path", ".path", "_", "_", "_", "_", "_", "_", "_", "_", "_", "_", "_", "_", "_absolute"
            ])
        )
        self.assertEqual(
            safe_path_join(os.sep.join(["base", "path"]), "/absolute", "..", "."),
            os.sep.join([base, "base", "path", "_absolute", "_", "_"])
        )
        self.assertEqual(
            safe_path_join(os.sep.join(["base", "path"]), "\\absolute", "..", "."),
            os.sep.join([base, "base", "path", "_absolute", "_", "_"])
