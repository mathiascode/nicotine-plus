...
def parse_ip_country_data():
    ...
    return sorted(country_codes), ip_range_values, ip_range_countries, copyright_notice
...
def update_ip_country_data():
    ...
    country_codes, ip_range_values, ip_range_countries, copyright_notice = parse_ip_country_data()
...
""".encode())
    ...
    output_countries = output_header.copy()

    # Countries
    for country_code in country_codes:
        output_countries.extend(f'{country_code.replace("-", "")},'.encode())

    # IP range countries
    for country_code in ip_range_countries:
        output_ip_range_countries.extend(f'{country_codes.index(country_code)},'.encode())
